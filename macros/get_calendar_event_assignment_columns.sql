...
{% set columns = [
    ...
    {"name": "id", "datatype": dbt.type_string(), "alias": "calendar_event_assignment_id"},
    ...
    {"name": "sitetracker_calendar_event_c", "datatype": dbt.type_string(), "alias": "calendar_event_id"},
    {"name": "sitetracker_mobile_name_c", "datatype": dbt.type_string(), "alias": "mobile_display_name"},
