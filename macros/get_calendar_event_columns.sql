...
{% set columns = [
    ...
    {"name": "id", "datatype": dbt_utils.type_string(), "alias": "calendar_event_id"},
    ...
    {"name": "sitetracker_duration_c", "datatype": dbt_utils.type_int(), "alias": "scheduled_duration"},
    {"name": "sitetracker_duration_unit_c", "datatype": dbt_utils.type_string(), "alias": "scheduled_duration_units"},
    {"name": "sitetracker_job_c", "datatype": dbt_utils.type_string(), "alias": "job_id"},
    ...
    {"name": "sitetracker_type_c", "datatype": dbt_utils.type_string(), "alias": "calendar_event_type"}
] %}
