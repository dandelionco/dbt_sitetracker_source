...
{% set columns = [
    ...
    {"name": "id", "datatype": dbt.type_string(), "alias": "job_id"},
    ...
    {"name": "sitetracker_estimated_duration_c", "datatype": dbt.type_int(), "alias": "scheduled_duration"},
    {"name": "sitetracker_duration_unit_c", "datatype": dbt.type_string(), "alias": "scheduled_duration_units"},
    {"name": "sitetracker_job_number_c", "datatype": dbt.type_string(), "alias": "job_number"},
    {"name": "sitetracker_job_status_c", "datatype": dbt.type_string(), "alias": "status"},
    {"name": "sitetracker_job_template_c", "datatype": dbt.type_string(), "alias": "job_template_id"},
    {"name": "sitetracker_job_type_c", "datatype": dbt.type_string(), "alias": "job_type"},
